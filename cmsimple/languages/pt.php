...
$tx['editmenu']['normal']="Modo Exibição";
$tx['editmenu']['pagedata']="Dados da Página";
$tx['editmenu']['pagemanager']="Páginas";
$tx['editmenu']['plugins']="Plugins";
$tx['editmenu']['settings']="Configurações";
$tx['editmenu']['stylesheet']="Folha de Estilo";
$tx['editmenu']['sysinfo']="Informações";
$tx['editmenu']['template']="Modelo";
$tx['editmenu']['userfiles']="Arquivos de Usuário";
...
$tx['error']['cntsave']="Não foi Possível Salvar";
$tx['error']['cntwriteto']="Não foi Possível Gravar em";
$tx['error']['fatal']="Ocorreu um Erro Fatal. Habilite <a href=\"http://www.cmsimple-xh.org/wiki/doku.php/troubleshooting#debug_mode\" target=\"_blank\">Modo de Depuração</a> Para Mais Informações.";
...
$tx['error']['nocookies']="Por favor, Habilite os Cookies!";
$tx['error']['nojs']="Por favor, Habilite o Javascript!";
$tx['error']['notreadable']="Não Legível";
$tx['error']['notwritable']="Não Gravável";
$tx['error']['plugincall']="Function %s() is not defined!";
$tx['error']['server']="Erro do Servidor: %s";
...
$tx['mailform']['captcha']="Digite este número (prevenção de spam)";
$tx['mailform']['captchafalse']="Por favor, insira o código anti-spam";
$tx['mailform']['message']="Mensagem";
$tx['mailform']['mustwritemessage']="Nenhuma mensagem foi inserida";
$tx['mailform']['notaccepted']="Por favor, preencha os campos necessários";
...
$tx['mailform']['senderphone']="Seu número de telefone: ";
$tx['mailform']['subject']="Assunto (obrigatório): ";
...
$tx['search']['found_1']="\"%s\" foi encontrado em uma página:";
$tx['search']['found_2-4']="\"%s\" foi encontrado em %d páginas:";
$tx['search']['found_5']="\"%s\" foi encontrado em %d páginas:";
$tx['search']['label']="Termos da Busca";
$tx['search']['notfound']="\"%s\" não foi encontrado.";
...
$tx['syscheck']['warning']="Atenção";
$tx['syscheck']['writable']="'%s' é gravável";
...
$tx['sysinfo']['unknown']="Não foi Possível Determinar o Servidor Web";
$tx['sysinfo']['webserver']="Servidor Web";

$tx['template']['active']="Modelo Ativo: ";
$tx['template']['default']="Modelo Padrão";

$tx['title']['bad_request']="Bad request";
$tx['title']['change_password']="Mudar Senha";
$tx['title']['cms']="Sistema de Gerenciamento de Conteúdo";
$tx['title']['downloads']="Downloads";
$tx['title']['images']="Imagens";
$tx['title']['log']="Arquivo de Log";
$tx['title']['mailform']="Formulário de E-Mail";
$tx['title']['media']="Arquivos de Mídia";
$tx['title']['xh_pagedata']="Limpeza de Dados da Página";
$tx['title']['password_forgotten']="Senha Esquecida";
$tx['title']['phpinfo']="PHP Info";
$tx['title']['plugins']="Plugins";
$tx['title']['search']="Buscar";
$tx['title']['settings']="Configurações";
$tx['title']['sitemap']="Mapa do Site";
$tx['title']['sysinfo']="Informação do Sistema";
$tx['title']['templates']="Modelos";
